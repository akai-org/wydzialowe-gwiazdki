            ...
            <div className="RegistrationContainer">
                <div className="RegistrationBox">
                    ...
                    <div className="TextBox">
                        <i class="icon-user"></i>
                        <input type="text" placeholder="Podaj e-mail"></input>
                    </div>
                    <div className="TextBox">
                        <i class="icon-key"></i>
                        <input type="password" placeholder="Podaj hasło"></input>
                    </div>
                    <div className="TextBox">
                        <i class="icon-key"></i>
                    ...
                    <input className="Button" type="button" name="" value="Zarejestruj sie!"></input>
                    <div className="Login">
                        {/* TODO -odnoscnik do logowanie i select  */}
                        Jeżeli masz konto <a className="LoginText" href="https://wydzialowe-gwiazdki.akai.org.pl/mainpage">zaloguj się.</a>
                    </div>
                </div>
            </div >
        );
